...
NirsMyDataDir = 'E:\ManDINet\Data_process\MA29';% Path setting
TemDir = fullfile(WorkingDir, 'temp');
MySaveDir = 'E:\ManDINet\Data_process\MA_fNIRS_data';
cd(MyToolboxDir);
...
for idx = 1 : 29 
    ...
    [cnt.ment, mrk.ment] = proc_appendCnt({cnt_temp{1}, cnt_temp{3}, cnt_temp{5}}, {mrk_temp{1}, mrk_temp{3}, mrk_temp{5}}); % merged mental arithmetic cnts
